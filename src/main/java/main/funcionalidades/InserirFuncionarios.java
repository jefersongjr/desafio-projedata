...
public class InserirFuncionarios {
	...
	public static List<Funcionario> listaDeFuncionario() {
		...
		list.add(new Funcionario("Maria", LocalDate.of(2000, 11, 10), 2009.44, "Operador"));
		list.add(new Funcionario("João", LocalDate.of(2001, 6, 12), 2284.38, "Operador"));
		list.add(new Funcionario("Caio", LocalDate.of(1961, 7, 02), 9836.14, "Coordenador"));
		list.add(new Funcionario("Miguel", LocalDate.of(1988, 11, 14), 19119.88, "Diretor"));
		list.add(new Funcionario("Alice", LocalDate.of(1995, 03, 05), 2234.68, "Recepcionista"));
		list.add(new Funcionario("Heitor", LocalDate.of(1999, 12, 19), 1582.72, "Operador"));
		list.add(new Funcionario("Arthur", LocalDate.of(1993, 2, 28), 4071.84, "Contador"));
		list.add(new Funcionario("Laura", LocalDate.of(1994, 5, 8), 3017.45, "Gerente"));
		list.add(new Funcionario("Heloísa", LocalDate.of(2003, 06, 24), 1606.85, "Eletricista"));
		list.add(new Funcionario("Helena", LocalDate.of(1996, 7, 02), 2799.93, "Gerente"));
		return list;
	}
}
